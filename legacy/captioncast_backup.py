...
FONT_MAP = {
    ...
    "Minecraft (Blocky)": "fonts/minecraft/Minecraft.ttf",
    "Pixel Operator (Pixel)": "fonts/pixel_3/pixel.ttf",
...
class App(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        # Header
        header_lbl = ctk.CTkLabel(self, text="CAPTOR HUB",
                                  font=ctk.CTkFont(family="Vin Mono Pro Bold", size=24),
                                  text_color="#FFFFFF")
        header_lbl.pack(pady=(12, 8), padx=20, anchor="w")
        ...
        ctk.CTkLabel(sf, text="Whisper Model:", text_color="#FFFFFF", font=font_reg).grid(row=0, column=0, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(sf, text="Language:", text_color="#FFFFFF", font=font_reg).grid(row=0, column=2, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(sf, text="OLED Font:", text_color="#FFFFFF", font=font_reg).grid(row=1, column=0, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(sf, text="Display Mode:", text_color="#FFFFFF", font=font_reg).grid(row=1, column=2, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(sf, text="Text Alignment:", text_color="#FFFFFF", font=font_reg).grid(row=2, column=0, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(sf, text="Text Case:", text_color="#FFFFFF", font=font_reg).grid(row=2, column=2, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(sf, text="OLED Brightness:", text_color="#FFFFFF", font=font_reg).grid(row=3, column=0, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(sf, text="Audio response:", text_color="#FFFFFF", font=font_reg).grid(row=3, column=2, padx=10, pady=5, sticky="w")
        self.vis_var = ctk.StringVar(value=self.active_settings.get("visualizer", "Sine Wave"))
        self.vis_menu = ctk.CTkComboBox(sf, variable=self.vis_var, values=["Sine Wave", "Stereo Bars", "Radial Ring"],
                                         state="readonly", border_width=1, border_color="#444444", corner_radius=6,
                                         fg_color="#121212", button_color="#1F1F1F", button_hover_color="#333333", text_color="#FFFFFF",
                                         font=font_reg, dropdown_font=font_reg)
        ...
        ctk.CTkLabel(sf, text="Audio Source:", text_color="#FFFFFF", font=font_reg).grid(row=4, column=0, padx=10, pady=5, sticky="w")
        ...
        ctk.CTkLabel(sf, text="Alert Hotword:", text_color="#FFFFFF", font=font_reg).grid(row=4, column=2, padx=10, pady=5, sticky="w")
        self.alert_var = ctk.StringVar(value=self.active_settings["alert"])
        self.alert_entry = ctk.CTkEntry(sf, textvariable=self.alert_var, fg_color="#121212", border_color="#444444", border_width=1, text_color="#FFFFFF", font=font_reg)
        ...
        ctk.CTkLabel(sf, text="Welcome Msg:", text_color="#FFFFFF", font=font_reg).grid(row=5, column=2, padx=10, pady=5, sticky="w")
        self.welcome_var = ctk.StringVar(value=self.active_settings["welcome"])
        self.welcome_entry = ctk.CTkEntry(sf, textvariable=self.welcome_var, fg_color="#121212", border_color="#444444", border_width=1, text_color="#FFFFFF", font=font_reg)
        ...
        self.music_cb = ctk.CTkCheckBox(sf, text="Music Mode (No Timeout/VAD)", variable=self.music_var,
            ...
            try:
                ...
                if self.active_settings.get("music_mode", False):
                    self.after(0, lambda: self.mdl_lbl.configure(
                        text="Music Mode Active ✓", text_color="#4CAF50"))
    ...
    def _poll(self):
        ...
        def get_font_size_for_name(font_name):
            pixel_fonts = ["Minecraft (Blocky)", "Pixel Operator (Pixel)", "MS Gothic (Monospace Pixel)", "SimSun (Monospace Pixel)", "Lucida Console (Retro)", "Vin Mono Pro (Regular)", "Vin Mono Pro (Bold)", "Vin Mono Pro (Thin)"]
            if font_name in pixel_fonts:
                return 16
